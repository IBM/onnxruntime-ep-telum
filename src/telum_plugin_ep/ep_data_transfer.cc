...
/*static*/
bool ORT_API_CALL TelumDataTransfer::CanCopyImpl(const OrtDataTransferImpl* this_ptr,
                                                   const OrtMemoryDevice* src_memory_device,
                                                   const OrtMemoryDevice* dst_memory_device) noexcept {
  const auto& impl = *static_cast<const TelumDataTransfer*>(this_ptr);
...
/*static*/
OrtStatus* ORT_API_CALL TelumDataTransfer::CopyTensorsImpl(OrtDataTransferImpl* this_ptr,
                                                             const OrtValue** src_tensors_ptr,
                                                             OrtValue** dst_tensors_ptr,
                                                             OrtSyncStream** streams_ptr,
                                                             size_t num_tensors) noexcept {
  auto& impl = *static_cast<TelumDataTransfer*>(this_ptr);
...
/*static*/
void ORT_API_CALL TelumDataTransfer::ReleaseImpl(OrtDataTransferImpl* /*this_ptr*/) noexcept {
  // In our setup the factory owns a shared TelumDataTransfer instance so it will do the cleanup, and we ignore
  ...
  // delete static_cast<TelumDataTransfer*>(this_ptr);
}
