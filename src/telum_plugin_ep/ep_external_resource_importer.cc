...
TelumExternalResourceImporter::TelumExternalResourceImporter(const ApiPtrs& apis)
...
/*static*/
bool ORT_API_CALL TelumExternalResourceImporter::CanImportMemoryImpl(
...
/*static*/
OrtStatus* ORT_API_CALL TelumExternalResourceImporter::ImportMemoryImpl(
  ...
  auto& impl = *static_cast<TelumExternalResourceImporter*>(this_ptr);
  ...
  *out_handle = nullptr;
  ...
  auto* handle = new (std::nothrow) TelumExternalMemoryHandle(*desc);
  if (handle == nullptr) {
...
/*static*/
void ORT_API_CALL TelumExternalResourceImporter::ReleaseMemoryImpl(
    _In_ OrtExternalResourceImporterImpl* /*this_ptr*/,
  ...
  auto* mem_handle = static_cast<TelumExternalMemoryHandle*>(handle);
  delete mem_handle;  // destructor frees simulated_ptr
}

/*static*/
OrtStatus* ORT_API_CALL TelumExternalResourceImporter::CreateTensorFromMemoryImpl(
    _In_ OrtExternalResourceImporterImpl* this_ptr,
  ...
  *out_tensor = nullptr;
  ...
  auto* handle = static_cast<const TelumExternalMemoryHandle*>(mem_handle);
...
/*static*/
bool ORT_API_CALL TelumExternalResourceImporter::CanImportSemaphoreImpl(
    _In_ const OrtExternalResourceImporterImpl* /*this_ptr*/,
...
/*static*/
OrtStatus* ORT_API_CALL TelumExternalResourceImporter::ImportSemaphoreImpl(
    _In_ OrtExternalResourceImporterImpl* this_ptr,
  ...
  *out_handle = nullptr;
  ...
  auto* handle = new (std::nothrow) TelumExternalSemaphoreHandle(*desc);
  if (handle == nullptr) {
...
/*static*/
void ORT_API_CALL TelumExternalResourceImporter::ReleaseSemaphoreImpl(
    _In_ OrtExternalResourceImporterImpl* /*this_ptr*/,
  ...
  auto* sem_handle = static_cast<TelumExternalSemaphoreHandle*>(handle);
  delete sem_handle;
}

/*static*/
OrtStatus* ORT_API_CALL TelumExternalResourceImporter::WaitSemaphoreImpl(
    _In_ OrtExternalResourceImporterImpl* this_ptr,
...
/*static*/
OrtStatus* ORT_API_CALL TelumExternalResourceImporter::SignalSemaphoreImpl(
    _In_ OrtExternalResourceImporterImpl* this_ptr,
    _In_ OrtExternalSemaphoreHandle* handle,
    _In_ OrtSyncStream* stream,
    _In_ uint64_t value) noexcept {
...
/*static*/
void ORT_API_CALL TelumExternalResourceImporter::ReleaseImpl(
    _In_ OrtExternalResourceImporterImpl* this_ptr) noexcept {
  delete static_cast<TelumExternalResourceImporter*>(this_ptr);
}
